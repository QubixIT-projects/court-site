(function(){
  ...
  var PRODUCTS = [
    { id:"4a",  sport:"badminton", brand:"Yonex", name:"Astrox 100ZZ Racket",       price:62500, stock:7,  desc:"Head-heavy carbon frame built for explosive smashes and fast net recovery." },
    { id:"4b", sport:"badminton", brand:"Yonex", name:"Mavis 350 Shuttlecocks",     price:3200,  stock:45, desc:"Tube of 6 nylon shuttles with consistent tournament-grade flight." },
    { id:"4c",    sport:"badminton", brand:"Yonex", name:"Power Cushion Comfort Z2",   price:24900, stock:11, desc:"Cushioned midsole built to absorb repeated lunges and sudden pivots." },

    { id:"5a",  sport:"tennis", brand:"Wilson", name:"Pro Staff 97 v14 Racket",      price:68000, stock:5,  desc:"Precision-tuned frame favoured by players who like to shape the ball." },
    { id:"5b",    sport:"tennis", brand:"Wilson", name:"US Open Extra Duty Balls",      price:3500,  stock:30, desc:"Can of 3 felt-core balls with durable felt for hard-court play." },
    { id:"5c",    sport:"tennis", brand:"Head", name:"Sprint Pro 3.5 Court Shoes",      price:27500, stock:9,  desc:"Reinforced toe cap built for hard sliding stops on clay and hard court." },

    { id:"6a",  sport:"squash", brand:"Dunlop", name:"Sonic Core Pro Racket",         price:45000, stock:6,  desc:"Lightweight teardrop frame for quick swings in tight rallies." },
    { id:"6b",    sport:"squash", brand:"Dunlop", name:"Double Yellow Dot Balls",        price:2800,  stock:20, desc:"Competition-grade balls with a low bounce for advanced play." },
    { id:"6c", sport:"squash", brand:"Eye Guard", name:"Protective Squash Goggles",   price:6500,  stock:14, desc:"Impact-rated lenses with anti-fog coating for full-speed rallies." },

    { id:"7a",  sport:"paddle", brand:"Babolat", name:"Technical Viper Paddle",        price:58000, stock:4,  desc:"Diamond-shaped power paddle with a textured carbon face." },
    { id:"7b",    sport:"paddle", brand:"Head", name:"Padel Pro S Balls",                 price:3000,  stock:22, desc:"Tube of 3 balls tuned for padel's lower bounce and enclosed courts." },
    { id:"7c",    sport:"paddle", brand:"Babolat", name:"Paddle Grip Overwrap",           price:1200,  stock:50, desc:"Tacky overgrip for a secure hold through long rallies." },

    { id:"8a",   sport:"tabletennis", brand:"Butterfly", name:"Timo Boll ALC Blade",     price:38500, stock:6,  desc:"Carbon-layered blade built for fast, controlled offensive play." },
    { id:"8b",    sport:"tabletennis", brand:"DHS", name:"3-Star Table Tennis Balls",      price:2200,  stock:35, desc:"Pack of 6 poly balls with consistent bounce for match play." },
    { id:"8c",  sport:"tabletennis", brand:"Butterfly", name:"Tenergy Rubber Sheet",     price:8900,  stock:12, desc:"High-grip rubber sheet for added spin and speed off the blade." },

    { id:"9a",   sport:"accessories", brand:"Yonex", name:"Sports Wristbands (Pair)",     price:1800,  stock:40, desc:"Terry-cloth wristbands that keep sweat off your grip." },
    { id:"9b",     sport:"accessories", brand:"New Balance", name:"Performance Cap",         price:4500,  stock:18, desc:"Lightweight breathable cap with a curved brim for court days." },
    { id:"9c",   sport:"accessories", brand:"Wilson", name:"Compression Ankle Socks (3-Pack)", price:2600, stock:33, desc:"Cushioned, breathable socks built for long sessions on court." }
  ];
